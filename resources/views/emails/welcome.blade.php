...
<table valign="top" class="text-center body" style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; text-align: center !important; margin: 0; padding: 0; border: 0;" bgcolor="#ffffff">
  <tbody>
    ...
    <div class="text-center focom-top" style="height: 100px; overflow: show;" align="center">
      <div class="focom-container bg-primary" style="background-color: #007bff; padding-top: 30px; height: 120px;">
        <a href="https://focomotor.com.ar/">
       		<img class="focom-img" src="https://focomotor.com.ar/img/focom-white.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 180px; border: 0 none;">
        </a>
      </div>
    </div>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
        <table class="px-2" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; padding-right: 8px; padding-left: 8px; margin: 0;" align="left">
        <div class="  focom-card" style="max-width: 520px;">
      <table class="mx-auto" align="center" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0 auto;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
        <div class="bg-white border shadow rounded text-center " style="background-color: #ffffff !important; border-radius: 4px !important; border: 1px solid #dee2e6;" align="center">
        <table class="pt-4 pb-5" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; padding-top: 24px; padding-bottom: 48px; margin: 0;" align="left">
        <h2 class="font-weight-normal text-center h1" 
            style="margin-top: 0; margin-bottom: 0; font-weight: normal !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="center">
            ¡{{ $user->name }} bienvenido a <a href="https://focomotor.com.ar/"><u>Focomotor.com.ar</u></a>!</h2>
      </td>
    </tr>
  </tbody>
</table>

        <table class="pb-5" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; padding-bottom: 48px; margin: 0;" align="left">
        <div class=" text-center" style="" align="center">
          <table class="pb-4" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; padding-bottom: 24px; margin: 0;" align="left">
        <p class="h4 font-weight-normal  text-center" style="line-height: 28.8px; font-size: 24px; font-weight: normal !important; vertical-align: baseline; width: 100%; margin: 0;" align="center">Publique su primer vehículo GRATIS ahora:</p>
      </td>
    </tr>
  </tbody>
</table>

          <table class="btn btn-primary text-white p-2" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px; color: #ffffff;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; color: #ffffff; margin: 0; padding: 8px;" align="center" bgcolor="#007bff">
        <div><a href="https://focomotor.com.ar/img/focom-white.png" class="focom-button-title text-white" style="font-size: 23px !important; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4px; line-height: 20px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #007bff; color: #ffffff; padding: 8px 12px; border: 1px solid #007bff;">Publicar mi vehículo</a></div>
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
        <table class="pt-5" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; padding-top: 48px; margin: 0;" align="left">
        <p class="  text-center" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="center">¿Tenés alguna pregunta? Visitá nuestra zona de <a href="https://focomotor.com.ar/"><u>preguntas frecuentes</u></a></p>
      </td>
    </tr>
  </tbody>
</table>
