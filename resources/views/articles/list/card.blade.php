...
<div class="col-6 col-sm-4 col-md-4 col-xl-3 focom-list focom-reset-padding p-1 p-sm-2 p-md-2">
    <a href="{{ route('articles.show', ['category' => Str::slug($article->name), 'slug' => $article->slug]) }}" class="text-dark">
        <div class="border rounded shadow bg-white rounded focom-list">
            ...
            <div class="px-1 px-md-2">  
                ...
                <div class="pt-3 m-1">
                    ...
                    <p class="pl-1 lead d-inline-block font-weight-normal">{{ $place }}</p>
                </div>
            </div>
        </div>
    </a>
